...
const OPENING = `Shalom. Que bom que você veio.

Antes de começarmos — como você está chegando aqui hoje? Não precisa ser perfeito. Pode ser uma palavra, uma sensação, uma pergunta que não sai da cabeça.
  ...
  return (
    <div className="flex flex-col h-full max-w-2xl mx-auto">
      ...
      <div className="px-6 py-4 border-b border-stone-100 bg-white">
        <p className="font-medium text-stone-800">Sessão com Rafa</p>
        <p className="text-xs text-stone-400">Terapeuta cristã · Confidencial</p>
      </div>

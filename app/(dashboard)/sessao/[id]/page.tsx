  ...
  if (!session) {
    return (
      <div className="p-8 text-center text-stone-400">
        ...
        <Link href="/sessao" className="text-amber-700 hover:underline">Voltar</Link>
      </div>
    );
  }
      ...
      <div className="px-6 py-4 border-b border-stone-100 bg-white flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            ...
            {session.mood && (
              <Badge variant="outline" className="text-xs py-0">Humor {session.mood}/10</Badge>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-4 border-t border-stone-100 bg-white">
        <div className="flex gap-3 items-end">
          <Textarea
            ...
            placeholder="Continuar a sessão... (Enter para enviar)"
